...
## Dataset
Una vez tokenizado el texto, tenemos que tomar muestras del mismo. En el `defines.h` definimos la macro `MAX_CONTEXT_SIZE` que nos sirve para decidir qué tan larga será la ventana de caracteres (IDs) que vamos a tomar para samplear.
